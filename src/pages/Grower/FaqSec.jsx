...
const FaqSec = () => {
  ...
  { id: 2, question: tr("faq_2_q"), answer: tr("faq_2_a") },
  { id: 3, question: tr("faq_3_q"), answer: tr("faq_3_a") },
  { id: 4, question: tr("faq_4_q"), answer: tr("faq_4_a") },
  { id: 5, question: tr("faq_5_q"), answer: tr("faq_5_a") },
];
    ...
    <section id='faq' className="font-sans bg-white py-12 md:py-24 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"> {/* Ensures content is above background */}
        ...
        <h1 className="font-Urbanist mt-1 font-semibold leading-tight tracking-tight capitalize text-textPrimary
                xs:text-Heading8 sm:text-Heading6 md:text-Heading5 lg:text-Heading4 xl:text-Heading3 2xl:text-Heading1 rtl:text-right">
          {tr("faq_heading")}
        </h1>
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                <button
                  className="w-full flex justify-between items-start text-left rtl:text-right py-3 px-6 md:py-4 md:px-8 focus:outline-none transition-colors duration-300"
                ...
                >
                  ...
                  <div className="shrink-0 bg-[#faf8f8] p-1 rounded-[100%] h-10 w-10 flex items-center justify-center">
                    {isOpen ? (
                      // Up arrow when open
